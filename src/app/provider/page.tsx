...
export default function ProviderPage() {
    ...
    const renderJobDetailsModal = () => {
        ...
        const popupData: JobDetails = {
            ...
            status: mappedStatus,
            description: job.description || raw.description || raw.comment || raw.details?.note || '',
            photos: (raw.images || raw.photos || raw.details?.serviceDetails?.photoUrls || []).filter((u: any) => typeof u === 'string' && u.startsWith('http')),
            clientAvatar: job.clientAvatar || raw.clientAvatar || raw.userPhotoURL || '',
            locationDetails: raw.locationDetails || (typeof raw.location === 'object' ? raw.location : null),
