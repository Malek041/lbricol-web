    ...
    return (
        ...
        >
            ...
            <div className="flex-1 overflow-y-auto w-full max-w-md mx-auto p-5 pb-32">
                ...
                {/* Balance Card */}
                <div className="bg-[#01A083] rounded-[20px] p-6 text-white mb-6 shadow-md relative overflow-hidden">
                ...
                <div className="bg-white rounded-[20px] p-5 shadow-sm border border-[#E6E6E6]">
                    ...
                    <div className="flex gap-2">
                        <input
                            ...
                            className="flex-1 min-w-0 bg-[#F5F5F5] rounded-xl px-4 py-3.5 text-[15px] font-medium text-[#1D1D1D] border border-transparent focus:border-[#01A083] focus:bg-white outline-none transition-all"
                            disabled={isLoading}
                        />
                        <button
                    ...
                    {message && (
                        <div className={`mt-4 flex items-start gap-2 text-[14px] font-medium ${message.type === 'success' ? 'text-[#01A083]' : 'text-red-500'}`}>
