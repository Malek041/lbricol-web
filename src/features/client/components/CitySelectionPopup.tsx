                ...
                >
                    <motion.div
                        ...
                        className={cn(
                            ...
                            isMobile ? "rounded-t-[32px] min-h-0" : "rounded-[32px] overflow-hidden"
                        )}
                        ...
                        <div className="flex items-center gap-3 px-5 py-4 flex-shrink-0 border-b border-neutral-100">
                            ...
                            <div className="flex-1">
                                ...
                                {step === 'area' && selectedArea && (
                                    <p className="text-[12px] text-[#01A083] font-bold">
                            ...
                            <AnimatePresence mode="wait">
                                        ...
                                        <div className="grid grid-cols-1 gap-2">
                                            {MOROCCAN_CITIES.map(city => (
                                                <motion.button
                                                    ...
                                                    className="flex items-center gap-3 w-full px-4 py-3.5 rounded-2xl border-2 border-neutral-100 bg-neutral-50 hover:border-[#01A083] hover:bg-[#01A083]/5 transition-all text-left"
                                                >
                                ...
                                {step === 'area' && (
                                    <motion.div key="area" initial={{ x: 20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} exit={{ x: -20, opacity: 0 }} className="p-5 space-y-4">
                                        ...
                                        {/* Search */}
                                        <div className="flex items-center gap-3 bg-neutral-50 border-2 border-neutral-200 rounded-2xl px-4 py-3 focus-within:border-[#01A083] transition-colors">
                                        ...
                                        <div className="grid grid-cols-2 gap-2 max-h-56 overflow-y-auto no-scrollbar">
                                            ...
                                            {areaSearch.trim() && !filteredAreas.some(a => a.toLowerCase() === areaSearch.trim().toLowerCase()) && (
                                                <button
                                                    ...
                                                    className={cn(
                                                        'col-span-2 flex items-center justify-center gap-2 px-3 py-3 rounded-xl border-2 border-dashed border-[#01A083] text-[13px] font-bold text-[#01A083] bg-[#01A083]/5 transition-all mb-1',
                                                        selectedArea === areaSearch.trim() ? 'bg-[#01A083] text-white border-[#01A083]' : ''
                                                    )}
                                                >
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={cn(
                                                            ...
                                                            sel ? 'bg-[#01A083] text-white border-[#01A083]' : 'bg-neutral-50 text-neutral-800 border-neutral-100 hover:border-neutral-300'
                                                        )}
                                                    >
                        ...
                        {step === 'area' && (
                            <div className="p-5 flex-shrink-0 border-t border-neutral-100">
                                <motion.button
                                    ...
                                    className="w-full h-13 bg-[#01A083] disabled:bg-neutral-200 text-white disabled:text-neutral-400 rounded-2xl text-[16px] font-black py-4 transition-all"
                                >
