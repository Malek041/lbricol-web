...
function SellingPointsBottomSheet({ 
  isOpen, 
  onClose, 
  onStartHostMode, 
  t, 
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[11000] flex items-end md:items-center justify-center bg-black/60 backdrop-blur-sm p-0 md:p-4"
          onClick={onClose}
        >
          <motion.div
            ...
            className={cn(
              "relative bg-white w-full max-w-[500px] shadow-2xl flex flex-col",
              isMobile ? "rounded-t-[32px] pb-10" : "rounded-[32px] overflow-hidden"
            )}
            onClick={e => e.stopPropagation()}
          >
            {isMobile && <WaveTop />}
            ...
            <button 
              onClick={onClose}
              className="absolute top-4 right-4 z-10 w-10 h-10 rounded-full bg-neutral-100 flex items-center justify-center text-black"
            >
              <X size={20} />
            </button>
            ...
            <div className="px-8 py-10 md:py-12">
              <h2 className="text-[32px] font-black leading-tight mb-8">
                {t({ en: 'Maximize your property potential', fr: 'Maximisez le potentiel de votre propriété' })}
              </h2>
              ...
              <div className="space-y-8 mb-12">
                <div className="flex gap-5">
                  ...
                  <div>
                    <h4 className="font-bold text-[18px] mb-1">{t({ en: 'Smart Income', fr: 'Revenus intelligents' })}</h4>
                    <p className="text-neutral-500 text-[14px]">{t({ en: 'Automate your short-term rental management and earn more.', fr: 'Automatisez la gestion de votre location courte durée et gagnez plus.' })}</p>
                  </div>
                </div>
                ...
                <div className="flex gap-5">
                  ...
                  <div>
                    <h4 className="font-bold text-[18px] mb-1">{t({ en: 'Save Time', fr: 'Gagnez du temps' })}</h4>
                    <p className="text-neutral-500 text-[14px]">{t({ en: 'Our automated workflows handle everything from cleaning to check-ins.', fr: 'Nos flux automatisés gèrent tout, du ménage aux check-ins.' })}</p>
                  </div>
                </div>
                ...
                <div className="flex gap-5">
                  ...
                  <div>
                    <h4 className="font-bold text-[18px] mb-1">{t({ en: 'Trusted Partners', fr: 'Partenaires de confiance' })}</h4>
                    <p className="text-neutral-500 text-[14px]">{t({ en: 'Access our network of verified service providers.', fr: 'Accédez à notre réseau de prestataires de services vérifiés.' })}</p>
                  </div>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full bg-black text-white py-5 rounded-[20px] font-bold text-[18px] shadow-lg active:scale-[0.98] transition-all"
              >
