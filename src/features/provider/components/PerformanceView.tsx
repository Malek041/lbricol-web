                    ...
                    {performanceTab === 'performance' && (
                        ...
                        >
                            ...
                            {performanceDetail === 'none' && (
                                <div className="bg-white pt-10 pb-4 border-b border-neutral-100 flex items-center justify-between">
                                    <div className="flex items-center gap-2 overflow-x-auto no-scrollbar px-6 flex-1">
                                        {Array.from({ length: 12 }).map((_, i) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={cn(
                                                        "flex-shrink-0 px-5 py-2.5 rounded-2xl text-[14px] font-black transition-all",
                                                        isSelected 
                                                            ? "bg-black text-white" 
                                    ...
                                    <button
                                        ...
                                        className="w-10 h-10 flex items-center justify-center text-black relative active:scale-90 transition-transform bg-neutral-50 rounded-xl mr-6"
                                    >
                                        <Bell size={18} strokeWidth={2.5} />
                                        {mobileNotificationsCount > 0 && (
                                            <div className="absolute top-2.5 right-2.5 w-1.5 h-1.5 bg-red-500 rounded-full border-1.5 border-white" />
                                        )}
                                    </button>
                                </div>
                            )}
                                        ...
                                        <AnimatePresence mode="wait">
                                            {performanceDetail === 'none' ? (
                                                <motion.div
                                                    ...
                                                    animate={{ opacity: 1 }}
                                                    exit={{ opacity: 0 }}
                                                    className="space-y-2 pb-32 bg-[#F2F2F2] min-h-screen"
                                                >
                                                        ...
                                                        <div className="bg-white px-6 py-4 pb-0">
                                                            <div className="bg-[#F0FBF8] border border-[#01A083]/20 rounded-2xl px-5 py-4 flex items-start gap-3">
                                                                ...
                                                                <p className="text-[13px] text-[#01A083] font-semibold leading-snug">
                                                                    {t({ en: 'Complete your first mission to start seeing your stats here.', fr: 'Terminez votre première mission pour voir vos stats ici.' })}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    )}
                                                    ...
                                                    <div className="bg-white">
                                                        ...
                                                        >
                                                            <div className="space-y-1">
                                                                <p className="text-[18px] font-black text-black leading-tight mb-2 lowercase first-letter:uppercase">{t({ en: 'Earnings', fr: 'Revenus' })}</p>
                                                                <p className="text-[15px] text-neutral-600">
                                                                    {t({ en: `${monthLabel} total:`, fr: `Total ${monthLabel} :` })}{' '}
                                                                    <span className="font-black text-[#006B4D] tracking-tight">{netEarnings.toFixed(0)} MAD</span>
                                                                </p>
                                                                <p className="text-[15px] text-neutral-600">
                                                                    {t({ en: 'Task count:', fr: 'Nombre de missions :' })}{' '}
                                                    ...
                                                    <div className="bg-white">
                                                        ...
                                                        >
                                                            <div className="flex-1 space-y-1">
                                                                <p className="text-[18px] font-black text-black leading-tight mb-2 lowercase first-letter:uppercase">{t({ en: 'Reviews', fr: 'Avis' })}</p>
                                                                ...
                                                                <p className="text-[14px] text-neutral-400 font-bold">
                                                                    ({monthRatings.length} {t({ en: 'reviews', fr: 'avis' })})
                                                                </p>
                                                            </div>
                                                            <ChevronRight size={22} strokeWidth={2.5} className="text-black ml-4" />
                                                        </button>
                                                    ...
                                                    <div className="bg-white">
                                                        ...
                                                        >
                                                            <div className="space-y-1">
                                                                <p className="text-[18px] font-black text-black leading-tight mb-2 lowercase first-letter:uppercase">{t({ en: 'Skills & Rates', fr: 'Compétences & Tarifs' })}</p>
                                                                <p className="text-[15px] text-neutral-600">
                                                                    {t({ en: 'Activated skills:', fr: 'Compétences actives :' })}{' '}
                                                                ...
                                                                <p className="text-[13px] text-neutral-400 font-bold leading-tight">
                                                                    {t({ en: '1 of your rates can be optimized to help your business.', fr: 'Un de vos tarifs peut être optimisé.' })}
                                                                </p>
                                                            </div>
                                                            <ChevronRight size={22} strokeWidth={2.5} className="text-black ml-4" />
                                                        </button>
                                                    ...
                                                    <div className="bg-white">
                                                        ...
                                                        >
                                                            <div className="flex-1">
                                                                <p className="text-[18px] font-black text-black mb-1">Elite</p>
                                                                <p className="text-[13px] text-neutral-400 font-bold mb-4">{t({ en: 'Become Elite and earn up to 3x more!', fr: 'Devenez Élite et gagnez jusqu\'à 3x plus !' })}</p>
                                                                
                                                                <div className="bg-[#E9F5F3] rounded-2xl p-4 border border-[#01A083]/10">
                                                                    <div className="flex justify-between items-center mb-2">
                                                                        <span className="text-[11px] font-black text-[#01A083] uppercase tracking-widest">{t({ en: 'Elite progress', fr: 'Progression Élite' })}</span>
                                                    ...
                                                    <div className="bg-white pt-8 pb-10 px-6">
                                                        <p className="text-[11px] font-black text-neutral-400 uppercase tracking-[0.2em] mb-5">{t({ en: 'GROW YOUR BUSINESS', fr: 'DÉVELOPPEZ VOTRE ACTIVITÉ' })}</p>
                                                        <div className="grid grid-cols-2 gap-4">
                                                            {[
                                                                { id: 'tips-profile', title: t({ en: 'Profile tips', fr: 'Profil' }), desc: t({ en: 'Get more clicks', fr: 'Plus de clics' }), icon: User, color: 'bg-[#FFC244]/10 text-black' },
                                                                { id: 'tips-pricing', title: t({ en: 'Pricing', fr: 'Tarifs' }), desc: t({ en: 'Earn more', fr: 'Gagnez plus' }), icon: Tag, color: 'bg-[#01A083]/10 text-[#01A083]' },
                                                            ].map((tip) => (
                                                                <motion.button
                                                                    key={tip.id}
                                                                    whileTap={{ scale: 0.97 }}
                                                                    onClick={() => setPerformanceDetail(tip.id as any)}
                                                                    className="flex flex-col items-start gap-4 p-5 bg-[#F9F9F9] border border-neutral-100 rounded-[28px] text-left hover:border-neutral-200 transition-all active:scale-95"
                                                                >
                                                ...
                                                <motion.div
                                                    ...
                                                    className="bg-[#FAFAFA] min-h-[100vh] flex flex-col relative"
                                                >
                                                    {/* Sticky Header */}
                                                    <div className="px-5 pt-6 pb-4 flex items-center gap-4 sticky top-0 z-10 bg-[#FAFAFA] border-b border-neutral-100">
                                                        <button
                                                        ...
                                                        <h2 className="text-[17px] font-bold text-black">
                                                            {performanceDetail === 'financial' && t({ en: 'Earnings', fr: 'Revenus' })}
                                                            {performanceDetail === 'operational' && t({ en: 'Reliability', fr: 'Fiabilité' })}
                                                            {performanceDetail === 'reputation' && t({ en: 'Reviews', fr: 'Avis' })}
                                                            {performanceDetail === 'marketing' && t({ en: 'Visibility', fr: 'Visibilité' })}
                                                            {performanceDetail === 'growth' && t({ en: 'Rank & Visibility', fr: 'Rang & Visibilité' })}
                                                            {performanceDetail === 'tips-profile' && t({ en: 'Profile Tips', fr: 'Conseils Profil' })}
                                                            {performanceDetail === 'tips-pricing' && t({ en: 'Pricing Tips', fr: 'Conseils Tarifs' })}
                                                            {performanceDetail === 'tips-stars' && t({ en: '5-Star Tips', fr: 'Conseils 5 Étoiles' })}
                                                            {performanceDetail === 'tips-visibility' && t({ en: 'Visibility Tips', fr: 'Conseils Visibilité' })}
                                                        </h2>
                                                    </div>
                                                    ...
                                                    <div className="flex-1 overflow-y-auto no-scrollbar pb-32">
                                                        ...
                                                        {performanceDetail === 'financial' && (
                                                            <div className="animate-in fade-in duration-300">
                                                                ...
                                                                <div className="px-6 pt-6 pb-5 border-b border-neutral-100 bg-white">
                                                                    <p className="text-[13px] text-neutral-500 mb-1">{t({ en: 'Net earnings this period', fr: 'Gains nets cette période' })}</p>
                                                                ...
                                                                <div className="bg-white mt-4 mx-4 rounded-2xl border border-neutral-100 overflow-hidden">
                                                                    <div className="flex items-center justify-between px-5 py-4 border-b border-neutral-50">
                                                                        <span className="text-[15px] text-neutral-700">{t({ en: 'Gross earnings', fr: 'Gains bruts' })}</span>
                                                                        <span className="text-[15px] font-bold text-black">{totalEarnings.toFixed(0)} MAD</span>
                                                                    </div>
                                                                    <div className="flex items-center justify-between px-5 py-4 border-b border-neutral-50">
                                                                        <span className="text-[15px] text-neutral-700">{t({ en: 'Platform fee (15%)', fr: 'Frais plateforme (15%)' })}</span>
                                                                        <span className="text-[15px] font-bold text-red-500">−{lbricolCommission.toFixed(0)} MAD</span>
                                                                    </div>
                                                                    <div className="flex items-center justify-between px-5 py-4">
                                                                        <span className="text-[15px] text-neutral-700">{t({ en: 'Referral bonus', fr: 'Bonus parrainage' })}</span>
                                                                ...
                                                                <div className="bg-white mt-4 mx-4 rounded-2xl border border-neutral-100 overflow-hidden">
                                                                    <div className="px-5 py-4 border-b border-neutral-50 flex items-center justify-between">
                                                                        <span className="text-[15px] font-bold text-black">{t({ en: 'Commission due to Lbricol', fr: 'Commission due à Lbricol' })}</span>
                                                                        <div className="flex items-center gap-1.5 px-2.5 py-1 bg-orange-50 rounded-full">
                                                                            <div className="w-1.5 h-1.5 rounded-full bg-orange-400 animate-pulse" />
                                                                            <span className="text-[11px] font-bold text-orange-500">{t({ en: 'Pending', fr: 'En attente' })}</span>
                                                                        </div>
                                                                    </div>
                                                                    <div className="px-5 py-4">
                                                                        ...
                                                                        {/* Transfer details */}
                                                                        <p className="text-[13px] font-bold text-neutral-500 mb-3">{t({ en: 'Transfer to:', fr: 'Virer vers :' })}</p>
                                                                        <div className="space-y-2 mb-4">
                                                                            <div className="flex justify-between">
                                                                                <span className="text-[14px] text-neutral-500">{t({ en: 'Name', fr: 'Nom' })}</span>
                                                                                <span className="text-[14px] font-bold text-black">Abdelmalek Tahri</span>
                                                                            </div>
                                                                            <div className="flex justify-between">
                                                                                <span className="text-[14px] text-neutral-500">{t({ en: 'Bank', fr: 'Banque' })}</span>
                                                                                <span className="text-[14px] font-bold text-black">Al Barid Bank</span>
                                                                            </div>
                                                                            <div className="flex items-center justify-between gap-2 mt-1 bg-neutral-50 px-4 py-3 rounded-xl border border-neutral-100 cursor-pointer active:scale-95 transition-all" onClick={() => { navigator.clipboard.writeText('350810000000000880844466'); alert(t({ en: 'Copied!', fr: 'Copié !' })); }}>
                                                                        ...
                                                                        <div className="flex flex-col gap-3 pt-2">
                                                                                    ...
                                                                                    input.onchange = (e: any) => {
                                                                                        ...
                                                                                        if (file) {
                                                                                            ...
                                                                                            reader.onload = (re) => {
                                                                                                ...
                                                                                                showToast({ variant: 'success', title: t({ en: 'Receipt Selected', fr: 'Reçu sélectionné' }), description: t({ en: 'Click submit to send for verification.', fr: 'Cliquez sur envoyer pour vérification.' }) });
                                                                                            };
                                                                            ...
                                                                            >
                                                                                ...
                                                                                {settlementReceipt ? t({ en: 'Change receipt', fr: 'Changer le reçu' }) : t({ en: 'Upload payment receipt', fr: 'Envoyer le reçu de paiement' })}
                                                                            </button>
                                                                            {settlementReceipt && (
                                                                                <button
                                                                                    ...
                                                                                    onClick={async () => {
                                                                                        ...
                                                                                        try {
                                                                                            ...
                                                                                            showToast({ variant: 'success', title: t({ en: 'Submission Received!', fr: 'Envoi reçu !' }), description: t({ en: 'Admin will verify within 24h.', fr: 'L\'admin vérifiera sous 24h.' }) });
                                                                                        } catch (error) {
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    {t({ en: 'Submit payment', fr: 'Envoyer le paiement' })}
                                                                                </button>
                                                                            )}
                                                                            <p className="text-center text-[12px] text-neutral-400">{t({ en: 'Verification within ~24 hours', fr: 'Vérification sous ~24 heures' })}</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        {performanceDetail === 'operational' && (
                                                            <div className="animate-in fade-in duration-300">
                                                                ...
                                                                <div className="px-6 pt-6 pb-5 bg-white border-b border-neutral-100 flex items-center gap-6">
                                                                    ...
                                                                    <div>
                                                                        <p className="text-[15px] font-bold text-black mb-0.5">{t({ en: 'Completion rate', fr: 'Taux d\'achèvement' })}</p>
                                                                        <span className={`text-[13px] font-semibold ${rScore >= 0.9 ? 'text-[#01A083]' : rScore >= 0.7 ? 'text-orange-500' : 'text-red-500'}`}>
                                                                            {rScore >= 0.9 ? t({ en: '🏆 Elite stability', fr: '🏆 Élite stabilité' }) : rScore >= 0.7 ? t({ en: '📈 Good, keep going', fr: '📈 Bien, continuez' }) : t({ en: '⚠️ Needs improvement', fr: '⚠️ À améliorer' })}
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div className="bg-white mt-4 mx-4 rounded-2xl border border-neutral-100 overflow-hidden">
                                                                    <div className="flex items-center justify-between px-5 py-4 border-b border-neutral-50">
                                                                        <span className="text-[15px] text-neutral-700">{t({ en: 'Completed missions', fr: 'Missions complétées' })}</span>
                                                                        <span className="text-[15px] font-bold text-black">{monthDoneJobs.length}</span>
                                                                    </div>
                                                                    <div className="flex items-center justify-between px-5 py-4 border-b border-neutral-50">
                                                                        <span className="text-[15px] text-neutral-700">{t({ en: 'Cancellations', fr: 'Annulations' })}</span>
                                                                    ...
                                                                    <div className="flex items-center justify-between px-5 py-4">
                                                                        <span className="text-[15px] text-neutral-700">{t({ en: 'System rank preference', fr: 'Préférence de rang' })}</span>
                                                                        <span className={`text-[15px] font-bold ${rScore >= 0.8 ? 'text-[#01A083]' : 'text-orange-500'}`}>{rScore >= 0.8 ? t({ en: 'Active', fr: 'Actif' }) : t({ en: 'Low', fr: 'Bas' })}</span>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div className="mx-4 mt-4 px-4 py-4 bg-blue-50 rounded-2xl flex items-start gap-3">
                                                                    ...
                                                                    <p className="text-[13px] text-blue-700 leading-relaxed">
                                                                        {t({ en: 'Cancellations impact your search rank. Keep your completion rate above 90% for maximum visibility.', fr: 'Les annulations impactent votre classement. Gardez un taux d\'achèvement supérieur à 90% pour une visibilité maximale.' })}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        )}
                                                        ...
                                                        {performanceDetail === 'reputation' && (
                                                            <div className="animate-in fade-in duration-300">
                                                                ...
                                                                <div className="px-6 pt-6 pb-5 bg-white border-b border-neutral-100">
                                                                    <p className="text-[13px] text-neutral-500 mb-1">{t({ en: 'Average rating', fr: 'Note moyenne' })}</p>
                                                                    ...
                                                                    <span className={`text-[13px] font-semibold ${Number(avgRating) >= 4.5 ? 'text-[#01A083]' : Number(avgRating) >= 3.5 ? 'text-orange-500' : 'text-red-500'}`}>
                                                                        {Number(avgRating) >= 4.5 ? t({ en: '🏆 Elite quality', fr: '🏆 Qualité élite' }) : Number(avgRating) >= 3.5 ? t({ en: '👍 Good work', fr: '👍 Bon travail' }) : t({ en: '⚠️ Needs focus', fr: '⚠️ À améliorer' })}
                                                                    </span>
                                                                </div>
                                                                ...
                                                                <div className="bg-white mt-4 mx-4 rounded-2xl border border-neutral-100 overflow-hidden">
                                                                    <div className="flex items-center justify-between px-5 py-4 border-b border-neutral-50">
                                                                        <span className="text-[15px] text-neutral-700">{t({ en: 'Reviews this month', fr: 'Avis ce mois-ci' })}</span>
                                                                ...
                                                                <div className="bg-white mt-4 mx-4 rounded-2xl border border-neutral-100 overflow-hidden px-5 py-4">
                                                                    <p className="text-[13px] font-bold text-neutral-500 mb-4">{t({ en: 'Rating breakdown', fr: 'Répartition des notes' })}</p>
                                                                ...
                                                                <div className="mx-4 mt-4 px-5 py-4 bg-white rounded-2xl border border-neutral-100">
                                                                    <p className="text-[15px] font-bold text-black mb-1">{t({ en: 'Recent Reviews', fr: 'Avis récents' })}</p>
                                                                    <p className="text-[14px] text-neutral-500 leading-relaxed">
                                                                        {monthRatings.length > 0 ? t({ en: 'You have solid feedback from your clients this month.', fr: 'Vous avez de bons retours de vos clients ce mois-ci.' }) : t({ en: 'No reviews yet. Complete more missions to earn stars!', fr: 'Pas encore d\'avis. Finalisez plus de missions pour gagner des étoiles !' })}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        )}
                                                            ...
                                                            <div className="animate-in fade-in duration-300">
                                                                <div className="px-6 pt-6 pb-5 bg-white border-b border-neutral-100">
                                                                    <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-[#01A083]/10 rounded-full mb-3">
                                                                        ...
                                                                        <span className="text-[12px] font-bold text-[#01A083]">{t({ en: 'Beta feature', fr: 'Fonctionnalité bêta' })}</span>
                                                                    </div>
                                                                    <p className="text-[15px] text-neutral-700 leading-relaxed">
                                                                        {t({ en: 'Search performance data is being calibrated. You\'ll soon see exactly how often your profile appears in client searches.', fr: 'Les données de performance de recherche sont en cours de calibration. Vous verrez bientôt combien de fois votre profil apparaît dans les recherches.' })}
                                                                    </p>
                                                                </div>
                                                        ...
                                                        {performanceDetail === 'growth' && (
                                                            <div className="animate-in fade-in duration-300">
                                                                {/* Score hero */}
                                                                <div className="px-6 pt-6 pb-5 bg-white border-b border-neutral-100">
                                                                    <p className="text-[13px] text-neutral-500 mb-1">{t({ en: 'Opportunity score', fr: 'Score d\'opportunité' })}</p>
                                                                    ...
                                                                    <span className={`text-[13px] font-semibold ${healthScore >= 80 ? 'text-[#01A083]' : healthScore >= 50 ? 'text-orange-500' : 'text-red-500'}`}>
                                                                        {healthScore >= 80 ? t({ en: '🏆 Elite — top of search results', fr: '🏆 Élite — en tête des résultats' }) : healthScore >= 50 ? t({ en: '📈 Growing — complete more missions', fr: '📈 En progression — complétez plus' }) : t({ en: '⚠️ Needs attention — low visibility', fr: '⚠️ Action requise — faible visibilité' })}
                                                                    </span>
                                                                </div>
                                                                ...
                                                                <div className="bg-white mt-4 mx-4 rounded-2xl border border-neutral-100 overflow-hidden px-5 py-5">
                                                                    <div className="flex items-center gap-3 mb-3">
                                                                        ...
                                                                        <p className="text-[16px] font-bold text-black">{t({ en: 'Unlock Rewards', fr: 'Débloquer des récompenses' })}</p>
                                                                    </div>
                                                                    <p className="text-[14px] text-neutral-500 leading-relaxed mb-4">
                                                                        {t({ en: 'Refer other Bricolers and earn 50 MAD for each one who completes their first mission.', fr: 'Parrainez d\'autres Bricoleurs et gagnez 50 MAD pour chacun qui termine sa première mission.' })}
                                                                    </p>
                                                                    <button
                                                        ...
                                                        {performanceDetail === 'tips-profile' && (
                                                            <div className="animate-in fade-in duration-300">
                                                                <div className="px-6 pt-6 pb-5 bg-white border-b border-neutral-100">
                                                                    <p className="text-[24px] font-black text-black leading-tight">{t({ en: 'The Magnet Profile', fr: 'Le Profil Aimant' })}</p>
                                                                    <p className="text-[14px] text-[#01A083] font-semibold mt-1">{t({ en: 'Get +35% more client interest', fr: '+35% d\'intérêt client en plus' })}</p>
                                                                </div>
                                                                <div className="space-y-3 p-4">
                                                                    <div className="bg-white rounded-2xl border border-neutral-100 overflow-hidden">
                                                                        <div className="px-5 py-4 border-l-4 border-amber-400">
                                                                            <p className="text-[13px] font-bold text-neutral-500 mb-1">{t({ en: 'Step 1: The Bio Formula', fr: 'Étape 1 : La formule de bio' })}</p>
                                                                            <p className="text-[14px] text-neutral-700 leading-relaxed italic">
                                                                                {t({ en: '"I\'m a [Niche] expert with [Years] exp. I help clients with [Problem A] & [Problem B]."', fr: '"Je suis expert en [Niche] avec [Années] d\'exp. J\'aide mes clients pour [Problème A] & [Problème B]."' })}
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    <div className="bg-white rounded-2xl border border-neutral-100 px-5 py-4">
                                                                        <p className="text-[13px] font-bold text-neutral-500 mb-1">{t({ en: 'Step 2: Social Proof', fr: 'Étape 2 : La preuve sociale' })}</p>
                                                                        <p className="text-[14px] text-neutral-700 leading-relaxed">
                                                                            {t({ en: 'Adding 3 high-quality photos of your work increases trust by 50%.', fr: 'Ajouter 3 photos de qualité de votre travail augmente la confiance de 50 %.' })}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        {performanceDetail === 'tips-pricing' && (
                                                            <div className="animate-in fade-in duration-300">
                                                                <div className="px-6 pt-6 pb-5 bg-white border-b border-neutral-100">
                                                                    <p className="text-[24px] font-black text-black leading-tight">{t({ en: 'Market Legend', fr: 'Légende du Marché' })}</p>
                                                                    <p className="text-[14px] text-[#01A083] font-semibold mt-1">{t({ en: 'Master your unit economics', fr: 'Maîtrisez votre rentabilité' })}</p>
                                                                </div>
                                                                <div className="space-y-3 p-4">
                                                                    <div className="bg-white rounded-2xl border border-neutral-100 px-5 py-4 flex gap-4">
                                                                        ...
                                                                        <div>
                                                                            <p className="text-[15px] font-bold text-black mb-1">{t({ en: 'Competitive Anchoring', fr: 'Positionnement concurrentiel' })}</p>
                                                                            <p className="text-[14px] text-neutral-500 leading-relaxed">{t({ en: 'Start 5% below market to build reviews, then raise your rate once you have a strong profile.', fr: 'Commencez 5 % sous le marché pour obtenir des avis, puis augmentez une fois votre profil renforcé.' })}</p>
                                                                        </div>
                                                                    </div>
                                                                    <div className="bg-white rounded-2xl border border-neutral-100 px-5 py-4 flex gap-4">
                                                                        ...
                                                                        <div>
                                                                            <p className="text-[15px] font-bold text-black mb-1">{t({ en: 'Add-on Strategy', fr: 'Stratégie complémentaire' })}</p>
                                                                            <p className="text-[14px] text-neutral-500 leading-relaxed">{t({ en: 'Suggest maintenance or extras — it boosts your average ticket without extra effort.', fr: 'Proposez maintenance ou options — cela augmente le panier moyen sans effort supplémentaire.' })}</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        {performanceDetail === 'tips-stars' && (
                                                            <div className="animate-in fade-in duration-300">
                                                                <div className="px-6 pt-6 pb-5 bg-white border-b border-neutral-100">
                                                                    <p className="text-[24px] font-black text-black leading-tight">{t({ en: '5-Star Protocol', fr: 'Protocole 5 Étoiles' })}</p>
                                                                    <p className="text-[14px] text-[#01A083] font-semibold mt-1">{t({ en: 'Build lifelong clients', fr: 'Fidélisez vos clients à vie' })}</p>
                                                                </div>
                                                                <div className="space-y-3 p-4">
                                                                    {[
                                                                        { t: t({ en: 'Be Early', fr: 'Soyez en avance' }), d: t({ en: 'Arriving 5 mins early leads to a 4.8-star average.', fr: 'Arriver 5 minutes en avance mène à une moyenne de 4,8 étoiles.' }) },
                                                                        { t: t({ en: 'Clean Up', fr: 'Nettoyez après' }), d: t({ en: 'Never leave tools or dust — the finish is what clients remember.', fr: 'Ne laissez jamais d\'outils ni de poussière — la finition est ce dont ils se souviennent.' }) },
                                                        ...
                                                        {performanceDetail === 'tips-visibility' && (
                                                            <div className="animate-in fade-in duration-300">
                                                                <div className="px-6 pt-6 pb-5 bg-white border-b border-neutral-100">
                                                                    <p className="text-[24px] font-black text-black leading-tight">{t({ en: 'Ranking Hacker', fr: 'Hacker de Classement' })}</p>
                                                                    <p className="text-[14px] text-[#01A083] font-semibold mt-1">{t({ en: 'Master the algorithm', fr: 'Maîtrisez l\'algorithme' })}</p>
                                                                </div>
                                                                <div className="space-y-3 p-4">
                                                                    <p className="text-[13px] font-bold text-neutral-500 px-1">{t({ en: 'Top ranking factors:', fr: 'Facteurs clés de classement :' })}</p>
                                                                    {[
                                                                        { icon: Check, color: 'bg-emerald-50 text-emerald-600', label: t({ en: 'High completion rate (>90%)', fr: 'Taux d\'achèvement élevé (>90%)' }) },
                                                                        { icon: Zap, color: 'bg-blue-50 text-blue-600', label: t({ en: 'Response time under 15 mins', fr: 'Temps de réponse inférieur à 15 min' }) },
                                                                        { icon: TrendingUp, color: 'bg-orange-50 text-orange-500', label: t({ en: 'Frequent commission settlements', fr: 'Règlements de commission fréquents' }) },
                                                                    ].map((item, idx) => (
