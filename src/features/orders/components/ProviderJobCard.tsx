    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-2 mt-2 justify-end w-full border-t border-neutral-50 pt-2 relative z-10">
                ...
                {(order.status === 'programmed' || order.status === 'accepted' || order.status === 'in_progress') && order.providerConfirmed && (
                    <div className="flex items-center gap-2 w-full justify-end">
                        ...
                        {(onStatusUpdate && (dynamicStatus === 'done' || dynamicStatus === 'in_progress' || order.status === 'in_progress')) && (
                          <button
                              onClick={(e) => {
                                  e.stopPropagation();
