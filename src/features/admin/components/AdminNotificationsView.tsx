                            ...
                            {notifications.map((notif, i) => (
                                <motion.button
                                    ...
                                    className={cn(
                                        ...
                                        !notif.read ? "bg-[#00A082]/[0.03]" : "bg-white",
                                        "hover:bg-neutral-50 active:bg-neutral-100"
                                    )}
                                >
                                    <div className="w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0 bg-[#E6F7F4] text-[#00A082]">
                                        <DollarSign size={22} />
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-start justify-between gap-2 mb-0.5">
                                            ...
                                            {!notif.read && <div className="w-2 h-2 rounded-full bg-[#00A082] flex-shrink-0 mt-1.5" />}
                                        </div>
