        ...
        const fetchUserData = async () => {
            try {
                ...
                if (userSnap.exists()) {
                    ...
                    setBricolerBalance(userSnap.data().bricolerReferralBalance || 0);
                }
    ...
    const handleApplyCode = async () => {
        ...
        try {
            ...
            await setDoc(currentUserRef, {
                ...
                referralDiscountAvailable: 50 // Grant 50 MAD discount
            }, { merge: true });

            setMessage({ text: t({ en: 'Promo code applied! You get 50 MAD off your first order.', fr: 'Code promo appliqué ! Vous obtenez 50 MAD de réduction sur votre première commande.', ar: 'تم تطبيق الرمز الترويجي! ستحصل على خصم بقيمة 50 درهم على طلبك الأول.' }), type: 'success' });
            setCode('');
