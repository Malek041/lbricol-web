...
const Footer = () => {
    ...
    const footerSections = [
        {
            title: t({ en: 'Company', fr: 'Entreprise' }),
            links: [
                { name: t({ en: 'About us', fr: 'À propos' }), href: '#' },
                { name: t({ en: 'Our offerings', fr: 'Nos services' }), href: '#' },
                { name: t({ en: 'Newsroom', fr: 'Salle de presse' }), href: '#' },
                { name: t({ en: 'Blog', fr: 'Blog' }), href: '#' }
            ]
        },
        {
            title: t({ en: 'Services', fr: 'Services' }),
            links: [
                { name: t({ en: 'Domestic Help', fr: 'Aide Ménagère' }), href: '#' },
                { name: t({ en: 'Go Delivery', fr: 'Livraison Go' }), href: '#' },
                { name: t({ en: 'Cleaning', fr: 'Nettoyage' }), href: '#' },
                { name: t({ en: 'Handyman', fr: 'Bricolage' }), href: '#' }
            ]
        },
        {
            title: t({ en: 'Partners', fr: 'Partenaires' }),
            links: [
                { name: t({ en: 'Become a Lbricolager', fr: 'Devenir un Bricoleur' }), href: '#' },
                { name: t({ en: 'Fleet owners', fr: 'Propriétaires de flotte' }), href: '#' },
                { name: t({ en: 'Business partners', fr: 'Partenaires commerciaux' }), href: '#' }
            ]
        },
        {
            title: t({ en: 'Support', fr: 'Support' }),
            links: [
                { name: t({ en: 'Help Center', fr: "Centre d'aide" }), href: '#' },
                { name: t({ en: 'Safety', fr: 'Sécurité' }), href: '#' },
                { name: t({ en: 'Terms of service', fr: "Conditions d'utilisation" }), href: '#' },
                { name: t({ en: 'Privacy policy', fr: 'Politique de confidentialité' }), href: '#' }
            ]
        }
    ];
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', gap: '2rem' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '13px', fontWeight: 700, cursor: 'pointer', color: c.text }}>
                            <MapPin size={16} />
                            <span>{t({ en: 'Morocco', fr: 'Maroc' })}</span>
                        </div>
                    </div>
                ...
                <div style={{
                    ...
                    <p>© 2026 Lbricol. {t({ en: 'All rights reserved.', fr: 'Tous droits réservés.' })}</p>
                    <p>{t({ en: 'Proudly built in Marrakesh. 🇲🇦', fr: 'Fièrement construit à Marrakech. 🇲🇦' })}</p>
                </div>
            </div>
        </footer>
    );
