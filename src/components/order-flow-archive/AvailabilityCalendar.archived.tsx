        ...
        >
            ...
            <div className="px-6 py-4 border-b flex items-center justify-between bg-white sticky top-0 z-20">
                ...
                <button
                    onClick={handleSave}
                    disabled={saving}
                    className="px-6 py-3 bg-[#01A083] text-white rounded-2xl font-black text-sm uppercase tracking-wider disabled:opacity-50 shadow-lg shadow-[#01A083]/20 active:scale-95 transition-all"
                >
                ...
                <div className="max-w-4xl mx-auto p-6 grid grid-cols-1 lg:grid-cols-2 gap-10">
                            ...
                            {days.map((day, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {hasSlots && (
                                            <div className="absolute bottom-1 w-1 h-1 bg-[#01A083] rounded-full" />
                                        )}
                                    </button>
                                )
                            })}
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-xs font-black text-[#01A083] uppercase tracking-widest bg-[#E6F6F2] px-3 py-1 rounded-full">
                                ...
                                return (
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            isActive
                                                ? "border-[#01A083] bg-[#01A083] text-white shadow-lg shadow-[#01A083]/20"
