                        ...
                        {state === 'offer' && (
                            ...
                            >
                                <h3 style={{ fontSize: '1.75rem', fontWeight: 900, marginBottom: '1.5rem', color: c.text, letterSpacing: '-0.03em' }}>
                                    {t({ en: 'New Offer Received', fr: 'Nouvelle offre reçue' })}
                                </h3>
                                ...
                                <div style={{
                                    ...
                                    <div>
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '4px', fontSize: '13px', fontWeight: 800 }}>
                                            ...
                                            <span style={{ color: c.textMuted, fontWeight: 500 }}>({lbricoler.jobs} {t({ en: 'jobs', fr: 'jobs' })})</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div style={{ marginBottom: '2.5rem' }}>
                                    <div style={{ fontSize: '11px', fontWeight: 900, color: c.textMuted, marginBottom: '4px', textTransform: 'uppercase' }}>
                                        {t({ en: 'PRICE PROPOSAL', fr: 'PROPOSITION DE PRIX' })}
                                    </div>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                    ...
                                    >
                                        {t({ en: 'Accept Offer', fr: "Accepter l'offre" })}
                                    </button>
                                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                                        ...
                                        >
                                            <RotateCcw size={18} /> {t({ en: 'Counter', fr: 'Contre-offre' })}
                                        </button>
                                        <button
                                            onClick={onClose}
                                            style={{
                        ...
                        {state === 'counter' && (
                            ...
                            >
                                <h3 style={{ fontSize: '1.5rem', fontWeight: 900, marginBottom: '1.5rem', color: c.text }}>
                                    {t({ en: 'Propose your price', fr: 'Proposez votre prix' })}
                                </h3>
                                <div style={{ backgroundColor: c.card, borderRadius: '24px', padding: '2.5rem', marginBottom: '2rem', display: 'flex', alignItems: 'center', justifyContent: 'center', border: `1px solid ${c.border}` }}>
                                    <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px' }}>
                                        <input
                                            ...
                                            autoFocus
                                        />
                                        <span style={{ fontSize: '1.5rem', fontWeight: 900, color: c.textMuted }}>MAD</span>
                                    </div>
                                </div>
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                    <button
                                    ...
                                    >
                                        {t({ en: 'Send Counter-offer', fr: 'Envoyer la contre-offre' })}
                                    </button>
                                    <button
                                    ...
                                    >
                                        {t({ en: 'Back to offer', fr: "Retour à l'offre" })}
                                    </button>
                                </div>
                            </motion.div>
                        )}
                        ...
                        {state === 'agreed' && (
                            ...
                            >
                                ...
                                <h3 style={{ fontSize: '2rem', fontWeight: 900, marginBottom: '1rem', color: c.text, letterSpacing: '-0.03em' }}>
                                    {t({ en: 'Deal Confirmed!', fr: 'Accord confirmé !' })}
                                </h3>
                                <p style={{ color: c.textMuted, fontSize: '17px', fontWeight: 500, lineHeight: 1.6, marginBottom: '2.5rem', maxWidth: '280px' }}>
                                    {t({
                                        en: "Ahmed is on his way. You can now chat to finalize details.",
                                        fr: "Ahmed est en route. Vous pouvez maintenant discuter pour finaliser les détails."
                                    })}
                                </p>
                                <button
                                    onClick={onClose}
                                ...
                                >
                                    {t({ en: 'Proceed to Dashboard', fr: 'Tableau de bord' })}
                                </button>
                            </motion.div>
                        )}
                    </AnimatePresence>
