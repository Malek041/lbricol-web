export const MOROCCAN_CITIES_AREAS: Record<string, string[]> = {
    ...
    Essaouira: [
        "Médina", "Bab Doukkala", "Douar Laghdir", "Douar Oljet", "Ait Daoud", "Moulay Hassan",
        "Lahcen Ben Daoud", "Lalla Mira", "Hay Salam", "Hay El Houma", "Zaouia"
    ],
    Agadir: [
...
export const SERVICE_TIER_RATES: Record<string, { tier: 'low' | 'medium' | 'high'; suggestedMin: number; suggestedMax: number }> = {
    ...
    elderly_assistance: { tier: 'medium', suggestedMin: 120, suggestedMax: 200 },
