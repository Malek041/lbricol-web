                        ...
                        <div className="overflow-y-auto flex-1 px-6 py-5 space-y-3">
                            {activeTab === 'language' ? (
                                ...
                                <>
                                    ...
                                    <div className="w-full flex items-center gap-4 p-4 rounded-2xl border-2 bg-[#00A08215] border-[#00A082]">
                                        <span className="text-3xl leading-none">🇲🇦</span>
                                        <div className="flex-1">
                                            <p className="text-[16px] font-black text-[#00A082]">{t({ en: 'Moroccan Dirham', fr: 'Dirham marocain', ar: 'الدرهم المغربي' })}</p>
