...
const SERVICES: ServiceEntry[] = [
    ...
    },
    {
        ...
        iconPath: '/Images/Vectors Illu/PetsCare_VI.png',
        subServices: [
    ...
    },
    {
        ...
        iconPath: '/Images/Vectors Illu/Errands_VI.png',
        subServices: [
    ...
    },
    {
        ...
        labelAr: 'مرشد سياحي',
        iconPath: '/Images/Vectors Illu/LocationFlag_VI.png',
        subServices: [
...
const ClientHome: React.FC<ClientHomeProps> = ({
    ...
    const visibleServices = React.useMemo(() => {
        ...
        // Smart sorting: place the last used category first
        if (lastCategoryId) {
        ...
        return base;
    }, [availableServiceIds, trendingSubServiceIds, lastCategoryId]);
