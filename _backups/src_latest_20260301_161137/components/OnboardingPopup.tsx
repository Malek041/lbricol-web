                                ...
                                {step === 'finish' && (
                                    <motion.div key="finish" custom={direction} variants={slideVariants} initial="enter" animate="center" exit="exit" className="p-6 md:p-10 space-y-10 max-w-md mx-auto py-12">
                                        ...
                                        <motion.div variants={itemVariants} initial="hidden" animate="show" className="space-y-6">
                                            ...
                                            <motion.button
                                                whileTap={{ scale: 0.98 }}
                                                onClick={mode === 'onboarding' ? handleGoogleSignup : handleUpdateProfile}
                                                ...
                                                {isSubmitting ? (
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        {mode === 'onboarding' ? (
                                                            <>
                                                                <FcGoogle size={22} />
                                                                <span>{t({ en: 'Connect with Google', fr: 'Se connecter avec Google', ar: 'الاتصال عبر جوجل' })}</span>
                                                            </>
                                                        ) : (
                                                            <>
                                                                <Save size={22} />
                                                                <span>{t({ en: 'Save Changes', fr: 'Enregistrer les modifications', ar: 'حفظ التعديلات' })}</span>
                                                            </>
                                                        )}
                                                    </div>
                                                )}
