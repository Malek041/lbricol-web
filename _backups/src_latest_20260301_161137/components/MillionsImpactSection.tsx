            ...
            <div style={{
                ...
                >
                    <h2 style={{
                        ...
                        {t({
                            en: "Facilitating the lives of millions, Lbricol connects you to expert help and seamless mobility.",
                            fr: "Facilitant la vie de millions de personnes, Lbricol vous connecte à une aide experte et à une mobilité fluide."
                        })}
                    </h2>
                </motion.div>
            </div>
