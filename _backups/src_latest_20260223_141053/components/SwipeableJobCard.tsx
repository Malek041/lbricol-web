    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <span className="text-3xl font-black text-green-500 uppercase tracking-widest">ACCEPT</span>
                </motion.div>
                ...
                >
                    <span className="text-3xl font-black text-red-500 uppercase tracking-widest">NOPE</span>
                </motion.div>
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                        {(job as any).status === 'urgent' && ( // Assuming status or urgent flag exists, otherwise mockup
                            <div className="px-3 py-1 bg-yellow-500/20 backdrop-blur-md border border-yellow-500/50 rounded-full flex items-center gap-1.5">
                                ...
                                <span className="text-[10px] font-black text-yellow-500 uppercase tracking-widest">Urgent</span>
                            </div>
                        )}
