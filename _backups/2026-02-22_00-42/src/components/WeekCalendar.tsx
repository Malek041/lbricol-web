...
`;
    ...
    useEffect(() => {
        if (!isFullscreenView || viewMode !== 'month') {
    ...
    const renderDayView = () => {
        ...
        return (
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: '600px', backgroundColor: c.bg }}>
                {/* Date Header */}
                <div style={{
                    padding: '2rem',
                    borderBottom: `1px solid ${c.border}`,
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(80px, 100px) 1fr', flex: 1 }}>
                    ...
                    <div style={{
                        ...
                        position: 'relative',
                        height: `${(11 * 140) + 32}px`, // Match sidebar height + potential padding
                        ...
                        {dayOrders.map((job, idx) => {
                            ...
                            // 09:00 is our start time (index 0)
                            const startHour = 9;
            ...
            <div style={{ display: 'flex', flexDirection: 'column', height: '100%', position: 'relative' }}>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <img
                            src={selectedOrder.pictures?.[0] || "https://cdn-icons-png.flaticon.com/512/1048/1048953.png"}
                            alt="service"
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                    {userType === 'client' ? (
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '4px', backgroundColor: '#FFCC0015', padding: '3px 10px', borderRadius: '100px', border: '1px solid #FFCC0020' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: 'auto' }}>
                    <button
                        ...
                        style={{
                            ...
                            cursor: 'pointer',
                            transition: 'all 0.2s',
                            boxShadow: '0 8px 24px rgba(255, 205, 44, 0.3)',
                                    ...
                                    <div>
                                        ...
                                        <div style={{ position: 'relative' }}>
                                            <select
                                                ...
                                                style={{ width: '100%', padding: '16px', borderRadius: '16px', border: `1px solid ${c.border}`, backgroundColor: c.surface, color: c.text, fontSize: '16px', fontWeight: 600, outline: 'none', appearance: 'none' }}
                                            >
                                                {timeSlots.map(t_val => <option key={t_val} value={t_val}>{t_val}</option>)}
                                            </select>
                                            <ChevronDown size={16} style={{ position: 'absolute', right: '16px', top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none', color: c.textMuted }} />
                                        </div>
                                    </div>
                                </div>
                            ...
                            >
                                ...
                                <div style={{ padding: '1.25rem 1.5rem', borderBottom: `1px solid ${c.border}66`, display: 'flex', alignItems: 'center', gap: '14px' }}>
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
                                        <div style={{ fontWeight: 900, fontSize: '16px', color: '#000', letterSpacing: '-0.01em' }}>{userType === 'client' ? (selectedOrder.bricolerName || 'Bricoleur') : (selectedOrder.clientName || 'Client')}</div>
                                ...
                                <div style={{ flex: 1, overflowY: 'auto', padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem', backgroundColor: '#F8F8F8' }} className="no-scrollbar">
                                    {chatMessages.length === 0 ? (
                                        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '1rem', color: c.textMuted, textAlign: 'center' }}>
                                            ...
                                            <p style={{ fontSize: '14px', fontWeight: 600 }}>Start the conversation with<br />your Bricoler</p>
                                        </div>
                                    ) : (
